...
export const metadata: Metadata = {
  ...
  description:
    "Wise Guys Windows is a local, family-run window cleaning crew serving Greater Victoria, BC. Honest pricing, spotless results, and a bit of fun.",
    ...
    <>
      ...
      <section className="py-20 sm:py-28">
        <Container className="grid items-center gap-12 lg:grid-cols-2">
          <div className="relative h-80 overflow-hidden rounded-2xl border border-smoke">
            <Image
      ...
      <section className="border-y border-smoke bg-noir py-20 sm:py-28">
        <Container>
